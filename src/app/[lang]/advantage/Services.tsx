            ...
            {cards.map((card) => (
              ...
              overflow-y-auto max-h-[20rem] pr-2 custom-scrollbar ${
                isArabic ? "text-right" : "text-left"
                  ...
                  <Link href="/buy-service" className="text-gray-500 border border-gray-400 font-bold px-4 py-2 rounded-lg mt-auto 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl mx-auto">
          {cards.map((card) => (
            ...
            >
              ...
              <Link href="/buy-service" className="text-black border
